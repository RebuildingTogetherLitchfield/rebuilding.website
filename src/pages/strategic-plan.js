      ...
      <div className={`container ${styles.mainContainer}`}>
        ...
        <div className="row">
          <p className={styles.planText}>
            ...
            visibility in Litchfield County will provide an increase # of
            low-income, elderly homeowner referrals, and volunteer teams.
            Emphasis will be placed on community recognition.
          </p>
          <p className={styles.planText}>
            There is the potential for creating smaller geographic zones with
          ...
          <ul className={styles.planTextList}>
            <li>Rebuilding Together Homeowners Safe At Home Program</li>
            <li>
              RT is responsible for construction budget, trainers and 'hands on'
              equipment necessary using paid contract labor, when necessary, who
              are reliable and can/will respond quickly & are known and
            ...
            <li>We would be sure that work was done in a timely manner.</li>
            <li>
